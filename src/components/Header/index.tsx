...
import DarkMode from "./Boton_ModoOscuro";
import MenuSettingsUser from "./MenuUser";
      ...
      <div className="flex flex-grow items-center justify-between px-4 py-5 shadow-2 md:px-5 2xl:px-10">
        ...
        <div className="hidden xl:block">
          <div>
            ...
            <p className="font-medium">Proyecto final de la materia Computación en la Nube.</p>
          </div>
        </div>
        <div className="flex items-center justify-normal gap-2 2xsm:gap-4 lg:w-full lg:justify-between xl:w-auto xl:justify-normal">
          ...
          {/* Menu desplegable para el perfil del usuario (Configuraciones) */}
          <MenuSettingsUser />
        </div>
      </div>
    </header>
